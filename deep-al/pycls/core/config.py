...
_C.ACTIVE_LEARNING.GEOAR_ALPHA = 1.0
_C.ACTIVE_LEARNING.GEOAR_BETA = 1.0
_C.ACTIVE_LEARNING.GEOAR_GAMMA = 0.0
_C.ACTIVE_LEARNING.GEOAR_K_ID = 10
_C.ACTIVE_LEARNING.GEOAR_K_KNN = 20
_C.ACTIVE_LEARNING.GEOAR_MODE = 'zero'
_C.ACTIVE_LEARNING.GEOAR_RADIUS = 0.0
_C.ACTIVE_LEARNING.GEOAR_GRAPH_MODE = 'knn'
_C.ACTIVE_LEARNING.GEOAR_RECOMPUTE_GREEDY = True
_C.ACTIVE_LEARNING.GEOAR_LOG_CSV = 'geometry_auto_research_rounds.csv'
_C.ACTIVE_LEARNING.GEOAR_UNCERTAINTY = 'entropy'
_C.ACTIVE_LEARNING.IDPC_K_ID = 50
_C.ACTIVE_LEARNING.IDPC_K_KNN = 50
_C.ACTIVE_LEARNING.IDPC_ALPHA = 1.0
_C.ACTIVE_LEARNING.IDPC_MODE = 'high_id_more_centers'
_C.ACTIVE_LEARNING.IDPC_EPS = 1e-8
_C.ACTIVE_LEARNING.IDPC_LOG_CSV = 'id_probcover_rounds.csv'
_C.ACTIVE_LEARNING.IDPC_CACHE_ROOT = ''
_C.ACTIVE_LEARNING.IDPC_L2_NORMALIZE_FEATURES = True
_C.ACTIVE_LEARNING.IDPC_PREFER_FAISS = True
_C.ACTIVE_LEARNING.IDPC_FAISS_GPU = True
_C.ACTIVE_LEARNING.IDPC_ADD_SELF_COVER = True
_C.ACTIVE_LEARNING.ARC_K_SIGNAL = 50
_C.ACTIVE_LEARNING.ARC_K_KNN = 50
_C.ACTIVE_LEARNING.ARC_ALPHA = 1.0
_C.ACTIVE_LEARNING.ARC_EPS = 1e-8
_C.ACTIVE_LEARNING.ARC_CACHE_ROOT = ''
_C.ACTIVE_LEARNING.ARC_L2_NORMALIZE_FEATURES = True
_C.ACTIVE_LEARNING.ARC_PREFER_FAISS = True
_C.ACTIVE_LEARNING.ARC_FAISS_GPU = True
_C.ACTIVE_LEARNING.ARC_ADD_SELF_COVER = True
